      ...
      {routinesInfo?.possibleRoutines.map(routine => {
        return (
          <div key={routine.id} className="flex items-center justify-between gap-3 group">
            ...
            >
              <div className='h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-blue-500 group-data-[state=checked]:border-blue-50 transition-colors group-focus:ring-2 group-focus:ring-blue-600 group-focus:ring-offset-2 group-focus:ring-offset-background'>
                <Checkbox.Indicator>
